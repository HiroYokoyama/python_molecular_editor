...
This comprehensive checklist is designed to verify that the software functions as documented, matches the intended design, and maintains scientific integrity.
1. Installation & Launch
 * [ ] Package Installation: Does the installation command (e.g., pip install) execute successfully?
 * [ ] Shortcut Creation: Does the post-installation script correctly create a shortcut in the application menu (Start Menu/Applications)?
 ...
 * [ ] Bond Modification: Does clicking an existing bond cycle its type (Single -> Double -> Triple)?
 ...
 * [ ] Chiral Labels: Does the "Show Chiral Labels" option correctly display R/S markers?
Editing Tools
...
4. File Operations
Project Management
 * [ ] Save Project: Can the workspace be saved as a project file with all data intact?

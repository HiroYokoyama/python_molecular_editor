...
def test_mainwindow_init_with_mocks():
    ...
    with patch('PyQt6.QtWidgets.QMainWindow.__init__', return_value=None):
        with patch('moleditpy.modules.main_window_main_init.MainWindowMainInit.init_ui'):
            with patch('moleditpy.modules.main_window_main_init.MainWindowMainInit.init_menu_bar'):
                 from moleditpy.modules.main_window import MainWindow

...
class DummyCellPicker:
    ...
    def Pick(self, x, y, z, renderer): pass
...
class DummyPlotterMinimal:
    ...
    def add_mesh(self, *a, **k): return mock.MagicMock()
    def add_point_labels(self, *a, **k): return []
    def clear(self): pass
    def render(self): pass
    def reset_camera(self): pass
    def add_light(self, *a, **k): return mock.MagicMock()
    @property
    def camera(self):
        c = mock.MagicMock()
...
class DummyPolyDataMock(mock.MagicMock):
    def __init__(self, *a, **k):
        ...
        self.point_data = {}
        self.cell_data = {}
    def __getitem__(self, key): return mock.MagicMock()
    def __setitem__(self, key, val): pass
    def glyph(self, *a, **k): return mock.MagicMock()
    def tube(self, *a, **k): return mock.MagicMock()

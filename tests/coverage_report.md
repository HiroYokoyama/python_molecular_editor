...
- **Overall Project Coverage**: **90.11%**
...
| moleditpy\src\moleditpy\plugins\plugin_manager_window.py |    273 |      6 |   97.8% |
...
| **TOTAL** | **17510** | **1731** | **90.11%** |

## Test Suite Status
- **Total tests passed**: 2374 (1 skipped)
- **Unit tests**: PASSED (2149 passed)

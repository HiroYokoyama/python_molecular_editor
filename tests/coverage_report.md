...
- **Overall Project Coverage**: **90.10%**
...
| moleditpy\src\moleditpy\plugins\plugin_manager_window.py |    209 |      2 |   99.0% |
...
| **TOTAL** | **17446** | **1727** | **90.10%** |

## Test Suite Status
- **Total tests passed**: 2364 (1 skipped)
- **Unit tests**: PASSED (2139 passed)

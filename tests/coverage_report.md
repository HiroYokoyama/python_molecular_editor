...
- **Overall Project Coverage (Full)**: **45.06%**
- **Core Molecular Logic Coverage**: **52.18%**
...
| moleditpy\src\moleditpy\modules\main_window_compute.py  |    821 |    387 |   52.9% |
...
| moleditpy\src\moleditpy\modules\main_window_molecular_parsers.py |    676 |    375 |   44.5% |

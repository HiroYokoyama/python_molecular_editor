...
CPK_COLORS = {
    ...
    "Nb": QColor("#68CFCE"),
    "Mo": QColor("#52B7B7"),
    "DEFAULT": QColor("#FF1493"),  # Pink fallback
}
...
# (symbol, row, column) of each element button in the periodic-table
# grids. Rows 8 and 9 hold the lanthanides and actinides.
PERIODIC_TABLE_LAYOUT: tuple[tuple[str, int, int], ...] = (
    ("H", 1, 1),
    ("He", 1, 18),
    ("Li", 2, 1),
    ("Be", 2, 2),

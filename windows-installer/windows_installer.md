...
[Download MoleditPy Windows Installer](https://github.com/HiroYokoyama/python_molecular_editor/releases/download/v4.2.1/MoleditPy_4.2.1_win64_setup.exe)

A portable version is also available:

[Download MoleditPy Windows Portable](https://github.com/HiroYokoyama/python_molecular_editor/releases/download/v4.2.1/MoleditPy_4.2.1_win64_portable.zip)

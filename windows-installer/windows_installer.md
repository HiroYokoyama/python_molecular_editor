...
[Download MoleditPy Windows Installer](https://github.com/HiroYokoyama/python_molecular_editor/releases/download/v4.9.0/MoleditPy_4.9.0_win64_setup.exe)

A portable version is also available:

[Download MoleditPy Windows Portable](https://github.com/HiroYokoyama/python_molecular_editor/releases/download/v4.9.0/MoleditPy_4.9.0_win64_portable.zip)

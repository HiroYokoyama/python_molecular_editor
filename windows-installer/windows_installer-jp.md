...
[MoleditPy Windows Installer をダウンロード](https://github.com/HiroYokoyama/python_molecular_editor/releases/download/v4.1.4/MoleditPy_4.1.4_win64_setup.exe)

ポータブル版もご利用いただけます：

[MoleditPy Windows Portable をダウンロード](https://github.com/HiroYokoyama/python_molecular_editor/releases/download/v4.1.4/MoleditPy_4.1.4_win64_portable.zip)

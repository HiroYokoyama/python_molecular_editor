...
注意: 本パッケージには`pip`が含まれていないため、外部依存関係（追加パッケージ）を必要とするプラグインは実行できません。
...
[MoleditPy Windows Installer をダウンロード](https://github.com/HiroYokoyama/python_molecular_editor/releases/download/v4.10.0/MoleditPy_4.10.0_win64_setup.exe)

ポータブル版もご利用いただけます：

[MoleditPy Windows Portable をダウンロード](https://github.com/HiroYokoyama/python_molecular_editor/releases/download/v4.10.0/MoleditPy_4.10.0_win64_portable.zip)

...
[MoleditPy Windows Installer をダウンロード](https://github.com/HiroYokoyama/python_molecular_editor/releases/download/v4.10.1/MoleditPy_4.10.1_win64_setup.exe)

ポータブル版もご利用いただけます：

[MoleditPy Windows Portable をダウンロード](https://github.com/HiroYokoyama/python_molecular_editor/releases/download/v4.10.1/MoleditPy_4.10.1_win64_portable.zip)

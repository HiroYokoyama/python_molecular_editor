...
[MoleditPy Windows Installer をダウンロード](https://github.com/HiroYokoyama/python_molecular_editor/releases/download/3.5.0/MoleditPy_3.5.0_win64_setup.exe)

ポータブル版もご利用いただけます：

[MoleditPy Windows Portable をダウンロード](https://github.com/HiroYokoyama/python_molecular_editor/releases/download/3.5.0/MoleditPy_3.5.0_win64_portable.zip)

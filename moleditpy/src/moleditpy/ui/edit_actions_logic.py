...
class EditActionsManager:
    ...
    def paste_from_clipboard(self):
        ...
        try:
            ...
            try:
                ...
                self.host.statusBar().showMessage("Error: Invalid clipboard data format")
                return
    ...
    def remove_hydrogen_atoms(self):
        ...
        try:
            ...
            if not hydrogen_map:
                self.host.statusBar().showMessage("No hydrogen atoms found to remove.", 2000)
                return
    ...
    def resolve_overlapping_groups(self):
        ...
        all_atom_items = [
            data["item"] for data in self.host.data.atoms.values() if data and "item" in data
        ]

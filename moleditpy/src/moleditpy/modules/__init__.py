...
_MAPPINGS = {
    ...
    # Core Logic
    'calculation_worker': 'moleditpy.core.calculation_worker',
    'mol_geometry': 'moleditpy.core.mol_geometry',
    'molecular_data': 'moleditpy.core.molecular_data',
    'main_window_compute': 'moleditpy.core.compute_engine',
    'main_window_app_state': 'moleditpy.core.app_state',
    'main_window_molecular_parsers': 'moleditpy.core.molecular_parsers',
    'main_window_project_io': 'moleditpy.core.project_io',
    'main_window_string_importers': 'moleditpy.core.string_importers',
        ...
        if self._mod is None:
            ...
            if self.__name__.endswith('.view_2d'):
                if not hasattr(self._mod, 'View2D'):
                    setattr(self._mod, 'View2D', getattr(self._mod, 'ZoomableView', None))
        return self._mod
...
try:
    ...
    def sip_isdeleted_safe(obj): return False

...
設定可能な項目:
  ...
  * **2D Settings タブ:**
      ...
      * **Template Settings:**
          * テンプレートのスナップ距離 (Template Snapping Distance): 既存の原子や結合にテンプレートをスナップさせる距離の閾値を設定します。
          * 原子の融合 (Fuse Atoms) の有効/無効: スナップ時にテンプレートと既存の原子を融合させるかどうかを切り替えます。
          * 結合の融合 (Fuse Bonds) の有効/無効: スナップ時にテンプレートと既存の結合を融合させるかどうかを切り替えます。

...
- [5. ファイル操作](#5-ファイル操作)
  - [5.1. プロジェクトファイル (.pmeprj (Python Molecular Editor Project File))](#51-プロジェクトファイル-pmeprj-python-molecular-editor-project-file)
  - [5.2. インポート](#52-インポート)
  - [5.3. エクスポート](#53-エクスポート)
- [6. 3D 機能](#6-3d-機能)
  - [6.1. 2D から 3D への変換](#61-2d-から-3d-への変換)
  - [6.2. 3D 構造の最適化](#62-3d-構造の最適化)
  - [6.3. 3D 表示スタイルの変更](#63-3d-表示スタイルの変更)
  - [6.4. 3D ビューの操作](#64-3d-ビューの操作)
  - [6.5. 3D 測定機能 ("3D Select" モード)](#65-3d-測定機能-3d-select-モード)
  - [6.6. 3D 編集機能 ("3D Drag" モード / Alt キー)](#66-3d-編集機能-3d-drag-モード-alt-キー)
  - [6.7. その他の 3D 編集機能 (メニュー `3D Edit`)](#67-その他の-3d-編集機能-メニュー-3d-edit)
  - [6.8. 制約付き最適化 (Constrained Optimization)](#68-制約付き最適化-constrained-optimization)
  - [6.9. 原子情報の表示](#69-原子情報の表示)
- [7. 分子分析](#7-分子分析)
- [8. 設定](#8-設定)
...
- [11. バージョン情報 / ライセンス](#11-バージョン情報-ライセンス)
...
**(設定):** メニューの `Edit` \> `3D Optimization Settings` または `Settings` \> `3D Optimization Settings` から、使用する力場計算ライブラリとメソッド (RDKit MMFF94/MMFF94s/UFF, Open Babel MMFF94/MMFF94s/UFF/GAFF/Ghemical) を選択できます。
...
### 6.8. 制約付き最適化 (Constrained Optimization)

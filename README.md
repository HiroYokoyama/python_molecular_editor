...
: A new issue was found between PyVista and the most recent releases of PyQt (6.10.0+). Please follow the guide at this [link]([https://github.com/HiroYokoyama/python_molecular_editor/requirements](https://github.com/HiroYokoyama/python_molecular_editor/tree/main/requirements)) to install.

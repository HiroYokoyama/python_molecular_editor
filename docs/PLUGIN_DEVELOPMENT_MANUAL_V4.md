...
> [!TIP]
> [Use this link to download the manual for offline reading or sharing with AI assistants.](https://hiroyokoyama.github.io/python_molecular_editor/docs/PLUGIN_DEVELOPMENT_MANUAL_V4.md)
...
> [!IMPORTANT]
> **API PHILOSOPHY**: In Version 4.0, it is strongly recommended that you avoid accessing the `MainWindow` directly via monkey-patching or unverified attributes. Instead, you should use the stable methods provided by the `PluginContext`. 
> 
